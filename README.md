...
```cxx
// main.cxx
#include "node_modules/xatlas.cxx/xatlas.h"
...
If you add the path `node_modules/xatlas.cxx` to your compiler's include paths.

```bash
$ clang++ -I./node_modules/xatlas.cxx main.cxx  # or, use g++
$ g++     -I./node_modules/xatlas.cxx main.cxx
```
...
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/jpcy/xatlas)
